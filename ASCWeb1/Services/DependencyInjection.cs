...
namespace ASCWeb1.Services
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddConfig(this IServiceCollection services, IConfiguration config)
        {
            ...
            // TẮT REDIS - DÙNG MEMORY CACHE THAY THẾ
            ...
            services.AddDistributedMemoryCache(); // Dùng MemoryCache thay Redis
        ...
        public static IServiceCollection AddMyDependencyGroup(this IServiceCollection services)
        {
            ...
            // Cache đã được đăng ký ở AddConfig() rồi, không cần đăng ký lại
            // services.AddDistributedMemoryCache(); // <-- XÓA DÒNG NÀY
